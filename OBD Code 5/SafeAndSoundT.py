...
# The header of car data log file
header = ["RunTime","RPM","Speed","CoolantTemp","IntakeTemp",
          "MAF","ThrottlePos","EngineLoad","FuelRate","OilTemp",
          "AmbiantTemp"]

hf.createLogFile(header , "test2")
...
# logging car data into csv file
hf.logCarData("test2")
